    ...
    return (
        <section className='h-screen flex items-center justify-center'>
            <div className='max-w-sm border shadow bg-white mx-auto p-8'>
                <h2 className='text-2xl font-semibold pt-5'>Please LRegister</h2>
            ...
            py-3 rounded-md'>Register</button>
                ...
                <p className='my-5 italic text-sm text-center'>Already have an account? Please<Link to='/register' className='text-red-700 px-1 underline'>Login</Link></p>
            </div>
        </section> 
  )
}
